    ...
    <div className="d-flex flex-column min-vh-100">
            ...
            <Card.Body className="p-4">
              ...
              {loading ? (
                ...
                <div className="text-center py-5">
                  <p className="text-muted mb-3">Không tìm thấy booking phù hợp với bộ lọc.</p>
          ...
          <Card className="shadow-sm border-0 rounded-4 overflow-hidden">
            ...
            <Card.Body className="p-4">
              ...
              {loading ? (
                ...
                <Alert variant="secondary" className="mb-0">Không tìm thấy order phù hợp với bộ lọc.</Alert>
              ) : (
                        ...
                        <Accordion.Body className="bg-light">
                          ...
                          {canEditOrder(order.status) && (
                            <Button size="sm" variant="outline-primary" onClick={() => openEditOrder(order)}>
                              <i className="bi bi-pencil-square me-1"></i>Sửa hoá đơn
                            </Button>
                          )}
                          <Button
                            size="sm"
      ...
      >
        <Modal.Body className="p-4">
          <div className="border rounded-4 p-4">
            ...
            <div className="text-secondary fw-semibold">HOÁ ĐƠN BOOKING</div>
            <hr />
        ...
        <Modal.Footer className="border-0 d-flex gap-2">
          ...
          <Button className="w-100" variant="primary" onClick={() => window.print()}>
            <i className="bi bi-printer me-2"></i>In hoá đơn booking
          </Button>
        </Modal.Footer>
      </Modal>
      ...
      >
        <Modal.Body className="p-4">
          <div className="border rounded-4 p-4">
            <h3 className="fw-bold mb-0">Coworking Space</h3>
            <div className="text-secondary fw-semibold">HOÁ ĐƠN ĐẶT HÀNG</div>
            <hr />
            <div className="fw-bold mb-2">THÔNG TIN ĐẶT HÀNG</div>
            <div className="d-flex justify-content-between">
              <span>Mã đơn</span>
              <strong>
        ...
        <Modal.Footer className="border-0 d-flex gap-2">
          ...
          <Button className="w-100" variant="primary" onClick={() => window.print()}>
            <i className="bi bi-printer me-2"></i>In hoá đơn
          </Button>
        </Modal.Footer>
      </Modal>
    </div>
