...
export default function AdminServiceListPage() {
  ...
  const loadItems = useCallback(async () => {
    ...
    try {
      // Admin cần thấy TẤT CẢ món (kể cả ẩn) → thêm param admin=true
  ...
  const setItemField = (field, value) => {
    ...
    // Xóa lỗi của field khi user sửa
                ...
                <Table responsive hover className="mb-0 align-middle">
                  ...
                  <tbody>
                    {filteredItems.map((item, idx) => {
                      ...
                      // Ẩn danh mục nếu thuộc cat đang Tạm ẩn → hiển thị nhãn "(Danh mục ẩn)"
              ...
              <Col md={4}>
                <Form.Group>
                  ...
                  <Form.Text className="text-muted" style={{ fontSize: 11 }}>
                    Nếu = 0 → tự động chuyển sang "Tạm hết"
                  </Form.Text>
                </Form.Group>
              </Col>
              <Col md={4}>
