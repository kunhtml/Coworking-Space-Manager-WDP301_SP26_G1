  ...
  return (
    <Modal show={show} onHide={onClose} size="md" centered>
      ...
      <Modal.Body className="px-4 pb-2">
        {invoiceLoading ? (
          <div className="text-center py-4">
            ...
            <p className="mt-2 text-muted small fw-semibold">Dang tai hoa don...</p>
          </div>
        ) : !invoiceData ? (
          <Alert variant="secondary" className="mb-0">Khong co du lieu hoa don.</Alert>
        ) : (
          <div>
      ...
      <Modal.Footer className="border-0 px-4 pb-4 gap-2">
        ...
        >
          {exporting
            ? <><Spinner size="sm" className="me-1" />Dang xuat...</>
            : <><i className="bi bi-download me-1" />Xuat hoa don (CSV)</>
          }
        </Button>
      </Modal.Footer>
    </Modal>
